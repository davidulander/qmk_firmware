 ...
 * |--------+------+------+------+------+------|  TAB |           | BkSp |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  | B/L2 |      |           |      |   N  |   M  |   ,  |   .  |-/Ctrl|  L1    |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |/CMD | NO |  NO  | NO | Space/L1 |                                      |Space/L1|  NO  |   ¨^  |   ´` |  '   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Alt  | LGui |       | Alt  |Ctrl  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,          KC_Z,             KC_X,             KC_C,         KC_V,       LT(ARRW,KC_B),       KC_TAB,
        KC_LGUI,          KC_NO,      KC_NO,           KC_NO,   LT(SYMB,KC_SPC),
                                                       KC_LALT, KC_LGUI,
                                                                KC_HOME,
