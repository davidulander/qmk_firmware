 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  | BkSp |           | BkSp |   Y  |   U  |   I  |   O  |   P  |   Å    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | BkSp   |   A  |Shft/S|Ctrl/D|F/Alt |G/CMD |------|           |------|Shft/H|J/Ctrl|Ctrl/K|Alt/L |   Ö  |   Ä    |
 * |--------+------+------+------+------+------|  TAB |           | Del  |------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        // right hand
             ...
             KC_DEL,      KC_N,           KC_M,         KC_COMM,        KC_DOT,         CTL_T(KC_SLSH),   LT(SYMB,KC_NUBS),
